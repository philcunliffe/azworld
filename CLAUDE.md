...
azworld is a TypeScript/Bun CLI toolkit for world-building that layers mutable, LLM-generated canonical content on top of Azgaar Fantasy Map Generator exports. It consists of two main applications:
...
- `src/wiki/` — Markdown wiki export with YAML frontmatter
...
- Keyword-based intent detection in chat (planned replacement with structured extraction)
